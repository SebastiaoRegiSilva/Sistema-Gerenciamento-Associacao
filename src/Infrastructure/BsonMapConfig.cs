using Hort.Etec.Apm.Infra.Alunos.Models;
using Hort.Etec.Apm.Infra.Armarios.Models;
using Hort.Etec.Apm.Infra.Classes.Models;
using Hort.Etec.Apm.Infra.Emails.Models;
using Hort.Etec.Apm.Infra.Predios.Models;
using Hort.Etec.Apm.Infra.Responsaveis.Models;
using MongoDB.Bson.Serialization;

namespace Hort.Etec.Apm.Infra
{
    /*
