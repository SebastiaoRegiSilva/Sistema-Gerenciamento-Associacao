namespace Hort.Etec.Apm.Domain.Responsaveis.Exceptions
{
    /// <summary>
    ///     Exceção de negócio lançada na tentativa de atribuição de um endereço de CPF inválido para uma entidade ou
    ///     objeto de valor.
    /// </summary>
