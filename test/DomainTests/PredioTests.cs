...
namespace Disparo.Plataforma.DomainTests
{
    ...
    public class PredioTests
    {
        ...
        private static PredioService _prediooService = null;
        ...
        public static void PrepareTestsData(TestContext context)
        {
            ...
            var prediooRepository = new PredioRepository(conString, database);
            _prediooService = new PredioService(prediooRepository);
        }
    }
}
